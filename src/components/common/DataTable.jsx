...
const DataTable = ({ columns, data, onRowClick, isLoading, searchable = false, pagination = true, pageSize = 10 }) => {
    ...
    if (!data || data.length === 0) {
        return (
            <div className="w-full p-12 text-center border rounded-lg bg-card dark:bg-slate-800">
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Table */}
            <div className="overflow-x-auto border rounded-lg shadow-sm bg-card dark:bg-slate-800">
                <table className="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody className="bg-card dark:bg-slate-800 divide-y divide-slate-200">
            ...
            {pagination && totalPages > 1 && (
                <div className="flex items-center justify-between px-4 py-3 bg-card dark:bg-slate-800 border border-slate-200 rounded-lg">
