...
export const SkeletonCard = () => (
    <div className="bg-card dark:bg-slate-800 p-6 rounded-lg shadow border border-slate-100">
...
export const SkeletonTable = ({ rows = 5, columns = 4 }) => (
    <div className="bg-card dark:bg-slate-800 rounded-lg shadow-sm border border-slate-100 overflow-hidden">
