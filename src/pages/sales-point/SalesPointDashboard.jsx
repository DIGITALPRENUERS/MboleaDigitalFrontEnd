              ...
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {filteredOfferings.map((o) => {
                  ...
                  return (
                    <article
                      key={o.id}
                      className={`rounded-2xl border bg-card p-5 shadow-sm transition-all hover:shadow-md hover:border-slate-300/80 dark:bg-slate-800 ${overTfra ? 'ring-2 ring-amber-300/80 border-amber-200' : 'border-slate-200'}`}
                    >
              ...
              <div className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50/80 to-teal-50/50 p-6 shadow-sm">
                ...
                <div className="mt-4 space-y-4">
                  {cartBySupplier.map(({ supplierUserId, supplierName, lines }) => {
                    ...
                    return (
                      <div key={supplierUserId} className="rounded-xl border border-emerald-200/80 bg-card p-4 dark:bg-slate-800">
...
setPaymentForm((f) => ({
        ...
        {pendingPayment && (
          <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-lg rounded-2xl bg-card shadow-xl p-6 space-y-4 dark:bg-slate-800">
              <div className="flex items-start justify-between gap-3">
                <div>
